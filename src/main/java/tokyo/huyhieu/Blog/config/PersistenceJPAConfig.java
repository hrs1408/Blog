...
@ComponentScan("tokyo.huyhieu.Blog")
@EnableJpaRepositories(basePackages = "tokyo.huyhieu.Blog.repository")
...
public class PersistenceJPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan(new String[] { "tokyo.huyhieu.Blog.model" });
